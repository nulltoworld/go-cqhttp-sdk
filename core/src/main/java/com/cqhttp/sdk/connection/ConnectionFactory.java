package com.cqhttp.sdk.connection;

import com.cqhttp.sdk.config.CQConfig;
import com.cqhttp.sdk.connection.impl.CQWebSocketClient;
import com.cqhttp.sdk.connection.impl.CQWebSocketServer;
import com.cqhttp.sdk.connection.impl.CustomHttpServer;
